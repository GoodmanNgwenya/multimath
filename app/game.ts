...
constructor(public player:Player,public problemCount:number,public factor:number){
    ...
    displayGame():void{
        ...
        //enable the calculate store button
    ...
    calculateScore():void{
        ...
        //loop through the text boxes and calculate the number that are cotrrect
        for(let i=1;i<=this.problemCount;i++){
        ...
        //create a new result object to pass the scoreboard
        const result:Result={
